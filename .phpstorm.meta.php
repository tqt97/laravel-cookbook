...
'admin.categories.form','admin.categories.index','admin.posts.form','admin.posts.index','admin.tags.form',
'admin.tags.index','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
'auth.reset-password','auth.verify-email','client.blogs.show','components.application-logo','components.auth-session-status',
'components.blogs.comment','components.blogs.item','components.blogs.show','components.clients.preserve-filters','components.danger-button',
'components.dropdown','components.dropdown-link','components.flash-message','components.forms.checkbox','components.forms.label',
'components.forms.select','components.icons.archive-box-x-mark','components.icons.arrow-long-down','components.icons.arrow-long-up','components.icons.arrow-up-right',
'components.icons.arrow-uturn-left','components.icons.arrows-up-down','components.icons.book-open','components.icons.calendar','components.icons.duplicate',
'components.icons.edit-pencil','components.icons.eye','components.icons.funnel','components.icons.heart','components.icons.home',
'components.icons.like-up','components.icons.message','components.icons.pencil-square','components.icons.plus','components.icons.search',
'components.icons.tag','components.icons.time','components.icons.trash','components.icons.user','components.icons.user-circle',
'components.icons.x-mark','components.input-error','components.input-label','components.modal','components.nav-link',
'components.primary-button','components.responsive-nav-link','components.secondary-button','components.text-input','components.users.avatar',
...
'post.title','post.pages.list','post.pages.create','post.pages.edit','post.pages.delete',
'post.pages.back','post.pages.show','post.form.title','post.form.slug','post.form.category_id',
'post.form.user_id','post.form.excerpt','post.form.content','post.form.select_category','post.form.select_user',
'post.form.is_featured','post.form.is_published','post.form.published_at','post.form.image','post.form.tags',
'post.form.no_select_tags','post.form.select_tags','post.columns.id','post.columns.title','post.columns.slug',
'post.columns.excerpt','post.columns.category_id','post.columns.user_id','post.columns.is_featured','post.columns.is_published',
'post.columns.published_at','post.columns.image','post.columns.status','post.columns.tags','post.columns.view_count',
'post.columns.comments_count','post.messages.create_success','post.messages.create_fail','post.messages.update_success','post.messages.update_fail',
'post.messages.delete_success','post.messages.delete_fail','post.messages.bulk_delete_success','post.messages.bulk_delete_fail','post.messages.bulk_delete_empty',
'post.messages.delete_image_fail','post.messages.restore_success','post.messages.restore_fail','post.messages.force_delete_success','post.messages.force_delete_fail',
'tag.title','tag.pages.list','tag.pages.create','tag.pages.edit','tag.pages.delete',
'tag.pages.back','tag.pages.show','tag.form.name','tag.form.slug','tag.form.posts',
'tag.form.select_posts','tag.columns.id','tag.columns.name','tag.columns.slug','tag.columns.posts',
'tag.messages.create_success','tag.messages.create_fail','tag.messages.update_success','tag.messages.update_fail','tag.messages.delete_success',
'tag.messages.delete_fail','tag.messages.bulk_delete_success','tag.messages.bulk_delete_fail','tag.messages.bulk_delete_empty','tag.messages.delete_image_fail',
'tag.messages.restore_success','tag.messages.restore_fail','tag.messages.force_delete_success','tag.messages.force_delete_fail',);
