...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/tuantq/laravel/laravel-cookbook/public/storage' => 'string',
            'horizon.domain' => 'NULL',
            'horizon.path' => 'string',
            'horizon.use' => 'string',
            ...
            'permission.permissions_list' => 'array',
            'pulse.domain' => 'NULL',
            'pulse.path' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./home/tuantq/laravel/laravel-cookbook/public/storage','horizon.domain','horizon.path','horizon.use',
...
'horizon.environments.production.supervisor-1.maxProcesses','horizon.environments.production.supervisor-1.balanceMaxShift','horizon.environments.production.supervisor-1.balanceCooldown','horizon.environments.local.supervisor-1.maxProcesses','ide-helper.filename',
...
'permission.cache.expiration_time','permission.cache.key','permission.cache.store','permission.permissions_list','pulse.domain',
...
'role.default','services.postmark.token','services.ses.key','services.ses.secret','services.ses.region',
...
'broadcasting.connections.ably.driver','broadcasting.connections.ably.key','broadcasting.connections.log.driver','broadcasting.connections.null.driver','livewire.class_namespace',
...
'livewire.inject_morph_markers','livewire.pagination_theme','tinker.commands','tinker.alias','tinker.dont_alias',);
...
'horizon.retry-jobs.show','horizon.jobs.show','horizon.index','pulse','livewire.update','livewire.upload-file','livewire.preview-file',
...
'password.confirm','password.update','logout','home',
'posts.show','comments.update','comments.store','comments.destroy','comments.reply',
'like.toggle','admin.categories.duplicate','admin.categories.bulk-delete','admin.categories.index','admin.categories.create',
'admin.categories.store','admin.categories.edit','admin.categories.update','admin.categories.destroy','admin.posts.duplicate',
'admin.posts.restore','admin.posts.force-delete','admin.posts.bulk-delete','admin.posts.index','admin.posts.create',
'admin.posts.store','admin.posts.edit','admin.posts.update','admin.posts.destroy','admin.tags.duplicate',
'admin.tags.bulk-delete','admin.tags.index','admin.tags.create','admin.tags.store','admin.tags.edit',
'admin.tags.update','admin.tags.destroy','admin.roles.bulk-delete','admin.roles.index','admin.roles.create',
'admin.roles.store','admin.roles.edit','admin.roles.update','admin.roles.destroy','admin.permissions.bulk-delete',
'admin.permissions.index','admin.permissions.create','admin.permissions.store','admin.permissions.edit','admin.permissions.update',
'admin.permissions.destroy','storage.local',);
        registerArgumentsSet('views', 
'admin.categories.form','admin.categories.index','admin.permissions.form','admin.permissions.index','admin.posts.form',
'admin.posts.index','admin.roles.form','admin.roles.index','admin.tags.form','admin.tags.index',
'auth.confirm-password','auth.forgot-password','auth.login','auth.register','auth.reset-password',
'auth.verify-email','client.blogs.show','components.application-logo','components.auth-session-status','components.blogs.comment',
'components.blogs.item','components.blogs.show','components.clients.preserve-filters','components.danger-button','components.dropdown',
'components.dropdown-link','components.flash-message','components.forms.checkbox','components.forms.label','components.forms.select',
'components.icons.archive-box-x-mark','components.icons.arrow-long-down','components.icons.arrow-long-up','components.icons.arrow-up-right','components.icons.arrow-uturn-left',
'components.icons.arrows-up-down','components.icons.book-open','components.icons.calendar','components.icons.duplicate','components.icons.edit-pencil',
'components.icons.eye','components.icons.funnel','components.icons.heart','components.icons.home','components.icons.like-up',
'components.icons.message','components.icons.pencil-square','components.icons.plus','components.icons.search','components.icons.tag',
'components.icons.time','components.icons.trash','components.icons.user','components.icons.user-circle','components.icons.x-mark',
'components.input-error','components.input-label','components.modal','components.nav-link','components.primary-button',
'components.responsive-nav-link','components.roles.permission-group','components.secondary-button','components.text-input','components.users.avatar',
'dashboard','home','layouts.app','layouts.filter','layouts.frontend-layout',
'layouts.guest','layouts.navigation','layouts.sidebar','profile.edit','profile.partials.delete-user-form',
'profile.partials.update-password-form','profile.partials.update-profile-information-form','pulse::dashboard','vendor.pulse.dashboard','welcome',
...
'7224ff0b1fa42156c352216deff15b56::user-card','horizon::layout','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'pagination.showing','pagination.to','pagination.of','pagination.results','pagination.pagination_navigation',
'pagination.go_to_page :page','passwords.reset','passwords.sent','passwords.throttled','passwords.token',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','category.title',
'category.pages.list','category.pages.create','category.pages.edit','category.pages.delete','category.pages.back',
'category.pages.show','category.form.name','category.form.parent','category.form.description','category.form.slug',
'category.form.position','category.form.is_active','category.form.submit','category.form.select_parent','category.form.category',
'category.form.categories','category.columns.id','category.columns.name','category.columns.slug','category.columns.parent',
'category.columns.position','category.columns.is_active','category.columns.action','category.messages.create_success','category.messages.create_fail',
'category.messages.update_success','category.messages.update_fail','category.messages.delete_success','category.messages.delete_fail','category.messages.bulk_delete_success',
'category.messages.bulk_delete_fail','category.messages.bulk_delete_empty','comment.create','comment.edit','comment.messages.create_success',
'comment.messages.create_fail','comment.messages.update_success','comment.messages.update_fail','comment.messages.delete_success','comment.messages.delete_fail',
'comment.messages.reply_success','comment.messages.reply_fail','common.create','common.update','common.delete',
'common.back','common.save','common.cancel','common.edit','common.no_data',
'common.search','common.search_placeholder','common.actions','common.reset','common.select',
'common.items','common.bulk_delete','common.list','common.confirm_delete','common.store_success',
'common.store_fail','common.update_success','common.update_fail','common.delete_success','common.delete_fail',
'common.bulk_delete_success','common.bulk_delete_fail','common.all','common.select_all','common.select_none',
'common.select_invert','common.active','common.trashed','common.confirm_restore','common.confirm_force_delete',
'common.restore_success','common.restore_fail','common.force_delete_success','common.force_delete_fail','common.restore',
'common.force_delete','common.delete_image_fail','common.published','common.unpublished','common.yes',
'common.no','common.popular','common.latest','common.oldest','common.most_viewed',
'common.most_liked','common.most_commented','common.most_shared','common.desc','common.asc',
'common.search_result_for','common.per_page','common.title','common.clear','nav.dashboard',
'nav.logout','nav.login','nav.register','nav.home','nav.about',
'nav.services','nav.contact','nav.categories','nav.posts','nav.tags',
'nav.roles','nav.permissions','permission.title','permission.pages.list','permission.pages.create',
'permission.pages.edit','permission.pages.delete','permission.pages.back','permission.pages.show','permission.form.name',
'permission.form.permissions','permission.form.select_permissions','permission.form.check_all','permission.columns.id','permission.columns.name',
'permission.columns.permissions','permission.columns.role','permission.messages.create_success','permission.messages.create_fail','permission.messages.update_success',
'permission.messages.update_fail','permission.messages.delete_success','permission.messages.delete_fail','permission.messages.bulk_delete_success','permission.messages.bulk_delete_fail',
'permission.messages.bulk_delete_empty','permission.messages.delete_image_fail','permission.messages.restore_success','permission.messages.restore_fail','permission.messages.force_delete_success',
'permission.messages.force_delete_fail','post.title','post.pages.list','post.pages.create','post.pages.edit',
'post.pages.delete','post.pages.back','post.pages.show','post.form.title','post.form.slug',
'post.form.category_id','post.form.user_id','post.form.excerpt','post.form.content','post.form.select_category',
'post.form.select_user','post.form.is_featured','post.form.is_published','post.form.published_at','post.form.image',
'post.form.tags','post.form.no_select_tags','post.form.select_tags','post.columns.id','post.columns.title',
'post.columns.slug','post.columns.excerpt','post.columns.category_id','post.columns.user_id','post.columns.is_featured',
'post.columns.is_published','post.columns.published_at','post.columns.image','post.columns.status','post.columns.tags',
'post.columns.view_count','post.columns.comments_count','post.messages.create_success','post.messages.create_fail','post.messages.update_success',
'post.messages.update_fail','post.messages.delete_success','post.messages.delete_fail','post.messages.bulk_delete_success','post.messages.bulk_delete_fail',
'post.messages.bulk_delete_empty','post.messages.delete_image_fail','post.messages.restore_success','post.messages.restore_fail','post.messages.force_delete_success',
'post.messages.force_delete_fail','role.title','role.pages.list','role.pages.create','role.pages.edit',
'role.pages.delete','role.pages.back','role.pages.show','role.form.name','role.form.roles',
'role.form.select_roles','role.form.check_all','role.columns.id','role.columns.name','role.columns.permissions',
'role.messages.create_success','role.messages.create_fail','role.messages.update_success','role.messages.update_fail','role.messages.delete_success',
'role.messages.delete_fail','role.messages.bulk_delete_success','role.messages.bulk_delete_fail','role.messages.bulk_delete_empty','role.messages.delete_image_fail',
'role.messages.restore_success','role.messages.restore_fail','role.messages.force_delete_success','role.messages.force_delete_fail','tag.title',
'tag.pages.list','tag.pages.create','tag.pages.edit','tag.pages.delete','tag.pages.back',
'tag.pages.show','tag.form.name','tag.form.slug','tag.form.posts','tag.form.select_posts',
'tag.columns.id','tag.columns.name','tag.columns.slug','tag.columns.posts','tag.messages.create_success',
'tag.messages.create_fail','tag.messages.update_success','tag.messages.update_fail','tag.messages.delete_success','tag.messages.delete_fail',
'tag.messages.bulk_delete_success','tag.messages.bulk_delete_fail','tag.messages.bulk_delete_empty','tag.messages.delete_image_fail','tag.messages.restore_success',
'tag.messages.restore_fail','tag.messages.force_delete_success','tag.messages.force_delete_fail',);
...
'MAIL_SCHEME','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','MAIL_MAILER','MAIL_HOST',
'MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY',
