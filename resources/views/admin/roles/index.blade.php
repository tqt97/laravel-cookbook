            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex items-center justify-between">
                        <h2 class="font-bold text-xl">{{ __('role.pages.list') }}</h2>
                    ...
                    <div class="flex mt-5 items-center justify-between">
                        ...
                        <div class="flex items-center gap-1">
                            <form id="bulk-delete-form" method="POST" action="{{ route('admin.roles.bulk-delete') }}">
                                @csrf
                                @method('DELETE')
                        ...
                        {{-- Search --}}
                        <div class="flex items-center gap-1">
                            <form action="{{ route('admin.roles.index') }}" method="GET" class="flex items-center gap-1">
                            ...
                            <a href="{{ route('admin.roles.index') }}" id="clear-filters-button" class="hidden">
                                <x-primary-button>
                        ...
                        <table class="w-full table-striped">
                            <thead>
                                <tr class="bg-gray-800 text-white text-left">
                                    ...
                                    <th class="px-4 py-4">{{ __('role.columns.name') }}</th>
                                    <th class="px-4 py-4">{{ __('role.columns.permissions') }}</th>
